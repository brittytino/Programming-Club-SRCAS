...
const Hackathon=() =>{
    ...
    return(
        // <div className='text-center flex gap-20 px-20 justify-center items-center mt-20 '>
        //     <img src={HackathonImg} alt="" className=' h-96 mt-5 rounded-tl-3xl rounded-br-3xl border-2 border-green' />
        //     <div className='flex flex-col gap-5'>
        //     <h1 className='text-secondary font-semibold text-xl md:text-3xl italic underline underline-offset-4 md:underline-offset-8 decoration-teal-600'>Don’t Blink, Something Epic Awaits..! </h1>
            
        //     <h1 className='text-teal-500 font-semibold md:text-xl text-sm mt-3'>Compiling the Details - Keep Checking In!</h1>
        //     </div>
        ...
        <div className='flex flex-col lg:order-2 items-center'>
          ...
          <h1 className='text-teal-500 font-semibold md:text-xl text-sm mt-5 lg:mt-10'>Compiling the Details - Keep Checking In!</h1>
        </div>
      </div>
